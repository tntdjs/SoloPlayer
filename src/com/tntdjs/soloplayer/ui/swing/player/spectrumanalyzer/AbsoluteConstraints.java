...
public class AbsoluteConstraints implements java.io.Serializable {
	 ...
	 *
	 * @param pos
	 *            The position to be represented by this AbsoluteConstraints
	 */
	 ...
	 *
	 * @param x
	 *            The X position to be represented by this AbsoluteConstraints
	 * @param y
	 *            The Y position to be represented by this AbsoluteConstraints
	 */
	 ...
	 *            The Y position to be represented by this AbsoluteConstraints
	 * @param width
	 *            The width to be represented by this AbsoluteConstraints or -1
	 *            if the component's preferred width should be used
	 * @param height
	 *            The height to be represented by this AbsoluteConstraints or -1
	 *            if the component's preferred height should be used
	 */
